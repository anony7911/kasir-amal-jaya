...
<body>
    <div style="margin-left:30px;margin-right:20px">
        ...
        <table style="width: 100%;text-align:center">
            <h5 style="margin-top:5px;margin-bottom:5px">LAPORAN STOK BARANG</h5>
            <h5 style="margin-top:5px;margin-bottom:5px;font-weight:normal;">PERIODE: {{ Carbon\Carbon::parse($tanggal_awal_barang)->format('d-m-Y') }} s/d {{ Carbon\Carbon::parse($tanggal_akhir_barang)->format('d-m-Y') }}
            </h5>
        </table>
        <p></p>
